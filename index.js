...
const corsOptions = {
	...
	origin: ['https://tech-e-com-client.onrender.com'], // Allow requests from this origin (The client's URL) the origin is in Array form if there are multiple origins
